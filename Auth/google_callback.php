...
try {
    ...
    if ($response->getStatusCode() == 200) {
        ...
        if ($userResponse->getStatusCode() == 200) {
            ...
            $pass = password_hash('fremax254', PASSWORD_BCRYPT);
            ...
            if (mysqli_num_rows($check_query) > 0) {
                ...
                $insert = "INSERT INTO users (First_Name, Last_Name, Email, Avatar, Pass, Reg_Date) VALUES ('$givenName', '$familyName', '$email', '$picture', '$pass', NOW())";
