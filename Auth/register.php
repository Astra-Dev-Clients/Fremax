...
if (isset($_POST['reg_new'])) {
    ...
    if ($stmt->execute()) {
            ...
            try {
                ...
                // Recipients
                $mail->setFrom($_ENV['GMAIL_USERNAME'], 'Fremax Graphics');
                $mail->addAddress($new_user, 'Coder Info');
                $mail->addReplyTo($_ENV['GMAIL_USERNAME'], 'Fremax Graphics');

                // Content
                $mail->isHTML(true);
                $mail->Subject = 'Register to Fremax Graphics';
                $mail->Body = '
                <!DOCTYPE html>
                <html lang="en">
                <head>
              ...
              <body>
                  <div class="container">
                      <div class="title">
                          <h1>Fremax Graphics</h1>
                      </div>
                      <div class="content">
                          <p>Thank you for your interest in Fremax Graphics. <br> Your Business success begins here!. <br> Kindly use the following link to register!</p>
                      </div>
                      <div class="register-link">
                          <a href="http://localhost/workspace/PortfolioReady/Auth/email_callback.php?token='.urlencode($token).'">Register Now</a>
                          <p>The link expires in 1 hour</p>
                      </div>
                      <footer>
                          <p>Best Regards,</p>
                          <p><strong>Fremax Graphics</strong></p>
                          <p><a href="https://fremax.co.ke">www.fremax.co.ke</a></p>
                          <p>info.fremax.co.ke</p>
                ...
                $mail->AltBody = 'Hello! Welcome to Fremax Graphics.';
